...
| a normative document about the canon's sub-module alone, kept beside its code — the canon having no `skills/`, and `module_skills/skill_*.md` holding the rules that cross modules or govern the project; a column of the skill matrix, like every skill | `module_skills/sub_module_scalability_crawler/skill_tui_designer.md` | — | — | a sub-module's rule among `module_skills/skill_*.md`; a `skills/` folder for one document |
...
`module_skills/sub_module_scalability_crawler/skill_tui_designer.md`.
